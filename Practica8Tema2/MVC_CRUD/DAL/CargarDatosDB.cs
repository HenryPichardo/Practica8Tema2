    ...
    public class CargarDatosDB : System.Data.Entity.DropCreateDatabaseIfModelChanges<EmpleadoContext>
    {
        protected override void Seed(EmpleadoContext context)
        {
            ...
            var Empleados = new List<Empleado>
            {
                ...
                new Empleado{Nombres="Belkys",Apellidos="Sandoval Polanco",Fecha_Ingreso=DateTime.Parse("2002-10-25")},
            ...
            var Registros = new List<Registro>
            {
                ...
                new Registro{EmpleadoID=3,DepartamentoID=2,Sueldo=Convert.ToDecimal(15000.00)},
                new Registro{EmpleadoID=4,DepartamentoID=2,Sueldo=Convert.ToDecimal(12000.00)}
            };
